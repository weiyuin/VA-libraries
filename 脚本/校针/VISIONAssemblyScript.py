...
if ncalibrateindex==0:
    ...
    #分析均值
    centerpos=GvTool.GetToolData("数组生成工具_6351.输出数组")
    num=0 
    #定义基准点XY为0.0
    totalx=0.0
    totaly=0.0
...
#显示轮廓
if GvTool.GetToolData("Blob工具_6349.执行结果"):
    VecVec2=GvTool.GetToolData("Blob结果解析_6352.轮廓边界点")
    ScImageShow.ImageShowPolyline(ScImageShow,guiArray,VecVec2, clrLineColor=[0,255,0], nLineWidth=2)
# 将 GUI 数组设置到视图——只需要设置一次在程序末尾
GvGuiDataAgent.SetGraphicDisplay("对针", guiArray)